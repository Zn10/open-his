...
import com.itbaizhan.openhis.config.pay.PayService;
...
import com.itbaizhan.openhis.dto.OrderChargeItemDto;
...
public class OrderChargeController {
    ...
    public AjaxResult createOrderChargeWithZfb(@RequestBody @Validated OrderChargeFromDto orderChargeFromDto) {
        ...
        String notifyUrl = "http://45314rh250.qicp.vip/pay/callback/" + orderId;
        Map<String, Object> map = PayService.pay(orderId, subject, totalAmount, undiscountableAmount, body, notifyUrl);
